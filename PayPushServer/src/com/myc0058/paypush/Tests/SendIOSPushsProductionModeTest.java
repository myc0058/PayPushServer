...
public class SendIOSPushsProductionModeTest {
	...
	public void test() throws Exception {
        ...
        try {
        	...
        	param.getDeviceTokens().add(
        			"D6E060D12C246B42524989E03D6C85AFBB224B"
        			+ "FEB6FF848E2364469B5BE87214");
         ...
         // Create a custom response handler
            ...
            IOSPushsResponse response = 
            		gson.fromJson(responseBody, IOSPushsResponse.class);
